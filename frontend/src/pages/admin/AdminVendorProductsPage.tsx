...
const AdminVendorProductsPage: React.FC = () => {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
        <div>
          <button
            ...
            className="flex items-center gap-2 text-[10px] font-black text-primary-500 uppercase tracking-widest mb-3 hover:text-primary-600 transition-colors"
          >
            <FiArrowLeft className="rtl:rotate-180" /> {t('admin.vendorProducts.back', 'Back to Vendor Directory')}
          </button>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight uppercase leading-none">{t('admin.vendorProducts.title', 'Vendor Master Catalog')}</h1>
          <p className="text-[11px] font-bold text-gray-400 mt-2 uppercase tracking-[0.2em]">{t('admin.vendorProducts.subtitle', 'Administrative Governance Control')}</p>
        </div>
        <button
